...
\zexternaldocument*[1:]{reference/Mathematics_Memorandum_v0.10.1} % usage: \zexternaldocument*[prefix]{path/to/aux/file/without/extension}[path/to/pdf/file] Only ascii name is allowed.
...
\begin{document}
	\title{motchyの信号処理備忘録}
	\author{motchy}
	\date{\西暦 2019年11月16日 $\sim$ \today \\ver 0.4.0}
	\maketitle
	...
	\input{parts/FourierAnalysis/FourierAnalysis.tex}
	...
	\begin{thebibliography}{9}
		\bibitem{数学備忘録}motchy (2022) 『数学備忘録 v0.10.1』\url{https://github.com/motchy869/Mathematics-Memorandum/releases/tag/v0.10.1}
	\end{thebibliography}
\end{document}
