			...
			\section{システムの伝達関数と正弦波入力の関係}
				...
				\begin{proof}
					...
					\begin{align*}
						...
						%&= \frac{\Ts}{2\pi}\integ{-\pi/\Ts}{\pi/\Ts}{\frac{1}{2i}H(\omega)\sum_{m=-\infty}^\infty \exp(i\omega\Ts m)\Bigl(\exp\bigl(i(\omega_0\Ts(n-m)+\phi)\bigr)-\exp\bigl(-i(\omega_0\Ts(n-m)+\phi)\bigr)\Bigr)}{\omega} \\
