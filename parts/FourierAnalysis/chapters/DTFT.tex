\chapter{離散時間Fourier変換(DTFT)}
    ...
    \section{GaussianノイズのDTFT}
        ...
        \begin{shadebox}
            ...
            これをサンプリング周期$\Ts>0$でサンプリングした$N$個の確率変数$X_n = X(n\Ts)\;(n=0,1,\cdots,N-1)$は互いに独立であり、自身の実部と虚部も独立であり、それぞれ$N(0,\sigma)$に従うとする。
        ...
        \begin{proof}
            ...
            よって$Y(\omega)$は$N(\bm{0}, \sqrt{N}\sigma I_2)$に従う。
