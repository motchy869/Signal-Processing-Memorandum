\chapter{サンプリング定理}
    ...
    \begin{proof}
        ...
        \begin{align*}
            f(\bm{x}) &= \mathcal{F}^{-1}\left(\FT{f},\bm{x}\right) = (2\pi)^{-d/2} \integrate{\realNumbers^d}{}{\FT{f}(\bm{\omega})\exp i\bm{\omega}^\top\bm{x}}{}{\bm{\omega}} = (2\pi)^{-d/2} \integrate{\Omega}{}{\FT{f}(\bm{\omega})\exp i\bm{\omega}^\top\bm{x}}{}{\bm{\omega}} \\
