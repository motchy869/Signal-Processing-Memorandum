\part{Hilbert変換}
    ...
    \chapter{sin, cosのHilbert変換}
        ...
        \begin{proof}
            ...
            \end{align*}
            最後から3番目の等号の成立には，$(\cos x)/x$の$[a,\infty)\;(a>0)$に於ける定積分が存在することを用いた。
            最後から2番目の等号の成立にはDirichlet積分を用いた。
        \end{proof}
