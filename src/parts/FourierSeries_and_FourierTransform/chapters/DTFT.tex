\chapter{離散時間Fourier変換(DTFT)}
    ...
    \section{積と畳み込みとの関係}
        ...
        \subsection{積のDTFT}
            ...
            \begin{align*}
                ...
                &= \sum_{\bm{n}\in\integers^d} \left(\frac{\prod_{k=1}^d T_{\mathrm{s},k}}{(2\pi)^d}\integrate{\Omega}{}{F(\tilde{\bm{\omega}})\NapierE^{i(\tilde{\bm{\omega}}\HadamardProd\bm{T}_\mathrm{s})^\top\bm{n}}}{}{\tilde{\bm{\omega}}}\right) g(\bm{n})\exp(-i(\bm{\omega}\HadamardProd\bm{T}_\mathrm{s})^\top\bm{n}) \\
                &= \frac{\prod_{k=1}^d T_{\mathrm{s},k}}{(2\pi)^d}\integrate{\Omega}{}{F(\tilde{\bm{\omega}})\left(\sum_{\bm{n}\in\integers^d} g(\bm{n})\NapierE^{-i\left((\bm{\omega}-\tilde{\bm{\omega}})\HadamardProd\bm{T}_\mathrm{s}\right)^\top\bm{n}}\right)}{}{\tilde{\bm{\omega}}} \\
        ...
        \subsection{積のIDTFT}
            ...
            \begin{align*}
                ...
                &= \frac{\prod_{k=1}^d T_{\mathrm{s},k}}{(2\pi)^d}\integrate{\Omega}{}{\left(\DTFTwithArg{f}{\bm{\omega}}\right)G(\bm{\omega})\exp(i(\bm{\omega}\HadamardProd\bm{T}_\mathrm{s})^\top\bm{n})}{}{\bm{\omega}} \\
                &= \frac{\prod_{k=1}^d T_{\mathrm{s},k}}{(2\pi)^d}\integrate{\Omega}{}{\left(\sum_{\bm{m}\in\integers^d} f(\bm{m})\exp(-i(\bm{\omega}\HadamardProd\bm{T}_\mathrm{s})^\top\bm{m})\right)G(\bm{\omega})\exp(i(\bm{\omega}\HadamardProd\bm{T}_\mathrm{s})^\top\bm{n})}{}{\bm{\omega}} \\
        ...
        \subsection{畳み込みのIDTFT}
            ...
            \begin{align*}
                ...
                &= \frac{\prod_{k=1}^d T_{\mathrm{s},k}}{(2\pi)^d}\integrate{\bm{\omega}\in\Omega}{}{\left(\frac{\prod_{k=1}^d T_{\mathrm{s},k}}{(2\pi)^d}\integrate{\tilde{\bm{\omega}}\in\Omega}{}{F(\tilde{\bm{\omega}})G(\bm{\omega}-\tilde{\bm{\omega}})}{}{\tilde{\bm{\omega}}}\right)\exp(i(\bm{\omega}\HadamardProd\bm{T}_\mathrm{s})^\top\bm{n})}{}{\bm{\omega}} \\
                &=
                \frac{\prod_{k=1}^d T_{\mathrm{s},k}}{(2\pi)^d} \int_{\tilde{\bm{\omega}}\in\Omega} \left(\frac{\prod_{k=1}^d T_{\mathrm{s},k}}{(2\pi)^d}\integrate{\bm{\omega}\in\Omega}{}{G(\bm{\omega}-\tilde{\bm{\omega}})\exp(i((\bm{\omega}-\tilde{\bm{\omega}})\HadamardProd\bm{T}_\mathrm{s})^\top\bm{n})}{}{\bm{\omega}}\right) \\
    ...
    \section{単一周波数波のDTFTの導出}
        ...
        \begin{align*}
            ...
            &= \frac{\pi}{\Ts i}\sum_{m\in\integers}\left(i\NapierE^{i\phi}\delta(\omega-\omega_0 - 2\pi m/\Ts) + i\NapierE^{-i(\phi)}\delta(\omega+\omega_0 - 2\pi m/\Ts)\right) \\
