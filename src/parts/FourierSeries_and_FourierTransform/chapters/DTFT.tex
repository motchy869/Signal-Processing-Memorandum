\chapter{離散時間Fourier変換(DTFT)}
    ...
    \section{定義}
        ...
        $\bm{\omega}$は各軸方向の角周波数をまとめて表したベクトルであり，$\bm{T}_\text{s}$は各軸方向のサンプル周期である。
