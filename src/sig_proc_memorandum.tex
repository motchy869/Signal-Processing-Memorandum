...
\newcommand{\docVerMinor}{21}
\newcommand{\docVerPatch}{0}
\newcommand{\docVerWip}{-wip} % -wip for work in progress, empty string for stable version
\newcommand{\docVer}{\docVerMajor.\docVerMinor.\docVerPatch\docVerWip}

\title{信号処理備忘録}
\author{motchy}
\date{\西暦2019年11月16日$\sim$ \today \\ver \docVer}
% --------------------
...
% \usepackage{cases} % currently not used
...
% \usepackage{tablefootnote} % currently not used
...
\usepackage{ulem} % for \uline etc.
\usepackage{upgreek} % for upright Greek letters in math mode (\upalpha, \upbeta, \upgamma, ...)
...
\zexternaldocument*[1:]{reference/mathematics_memorandum_v0.23.0} % usage: \zexternaldocument*[prefix]{path/to/aux/file/without/extension}[path/to/pdf/file] Only ascii name is allowed.
...
\setlength{\cftparanumwidth}{6.0em}
...
\sisetup{
    group-minimum-digits=4 % use group separator for numbers with 4 or more digits
}
% --------------------

\input{cmds/MtyLaTeXCmds/MtyLaTeXCmds.tex}
\input{cmds/common_cmd.tex}
...
\begin{document}
    ...
    \begin{thebibliography}{9}
        ...
        \bibitem{数学備忘録}motchy (2022)『数学備忘録v0.23.0』\url{https://github.com/motchy869/Mathematics-Memorandum/releases/tag/v0.23.0}
